 ...
 * Publicaciones — ADR-0004 —, renovación de tokens de Meta — ticket 07 — y
 * promoción de Ideas calendarizadas — ADR-0013) sin depender de un cron de
 * sistema ni de una cola externa.
 */
export async function register() {
  ...
  const { startIdeasWorker } = await import("@/lib/worker/ideas-worker");
  startIdeasWorker();
}
